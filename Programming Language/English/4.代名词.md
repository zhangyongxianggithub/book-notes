...
either/neither也有副词的用法，表示也不
- Bill didn't come to my party and Ken didn't either/ neither did Ken

some/any一般而言some用于肯定句，any用于否定句、疑问句以及条件句，可以代替可数或者不可数
...
other/another
other: 表示其他人或者其他事物的意思，复数为others, other通常是形容词，the other就是代名词了
another: 从an other衍生而来，表示不特定的另一个别的人或者事物无复数
...
![other的具体用法](pic/other用法.png)

none: 没有
- None of the telephones is/are working

serveral: 几个/数个
- Serveral of my friends attended the meeting

most: 大部分,前面不能加the
- Most of it is true
- Most of the people know it

most 可以当形容词为many、much的最高级，前面可以加the
