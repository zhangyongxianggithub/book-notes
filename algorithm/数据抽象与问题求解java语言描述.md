...
![排序](数据抽象与问题求解java语言描述/sort-component.png)
...
![功能分解](数据抽象与问题求解java语言描述/方法分解.png)
...
![一个简单的类图](数据抽象与问题求解java语言描述/简单的类图.png)
...
![生兔子的问题](数据抽象与问题求解java语言描述/rabbit.png)
...
P(n)=P(n-1)+P(n-2).
得到的公式是：
![游行的彩车的问题](数据抽象与问题求解java语言描述/parade.png)
- 可以通过分解来解决问题;
- 基例值非常重要。
...
![访问行星的组合的方法](数据抽象与问题求解java语言描述/compose.png)
## 3.3 数组查找
...
- 将该策略递归的用于一个数组段.
公式是
![第k个最小项](数据抽象与问题求解java语言描述/ksmall.png)
下面是伪码解决方案
```java
...
![语法图](数据抽象与问题求解java语言描述/%E8%AF%AD%E6%B3%95%E5%9B%BE.png)
或者使用文字语法表示:
...
![航班图数据](数据抽象与问题求解java语言描述/flight-graph.png)
...
![划分算法的不变式](数据抽象与问题求解java语言描述/快速排序.drawio.png)
在整个划分的过程中
...
![](数据抽象与问题求解java语言描述/快速排序-第%202%20页.drawio.png)
...
各种排序算法的时间比较如下:
![排序算法的对比](数据抽象与问题求解java语言描述/sort-algorithms.png)
